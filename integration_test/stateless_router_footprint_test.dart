...
void main() {
  ...
  group(
    '7618ANSA-019: Stateless Router Zero Local Footprint Integration Tests',
    () {
      testWidgets(
        '1. Happy-Path: Navigates statelessly and verifies 0 KB local cache',
        (tester) async {
          app.main();
          ...
          expect(
            find.textContaining('Volatile Local Cache Memory Marker: 0 KB'),
            findsOneWidget,
          );
      ...
      testWidgets(
        '2. Failure Scenario: Deep-link missing tracking key triggers interceptor',
        (tester) async {
          app.main();
          await tester.pumpAndSettle();
