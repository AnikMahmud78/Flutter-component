// lib/widgets/state_persistence_banner.dart
import 'package:flutter/material.dart';

class StatePersistenceBanner extends StatelessWidget {
  final String status;
  final double reliability;

  const StatePersistenceBanner({
    super.key,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Visual State Persistence: $status',
                ...
                Text(
                  'Reliability: ${(reliability * 100).toInt()}% (ISO/IEC 25010 Data Persistence)',
