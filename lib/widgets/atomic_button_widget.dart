          ...
          children: [
            Card.filled(
              ...
              child: const ListTile(
                ...
                subtitle: Text(
                  '1:1 theme-token mapping with 48x48 target and 8px safety padding.',
                ),
              ),
            ),
            const SizedBox(height: 20),
            const Text(
              'Pure AtomicButton Render',
              ...
              child: Center(
                child: AtomicButton(
                  onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Atomic action triggered.')),
                  ),
            ...
            Card.outlined(
              child: ListTile(
                title: Text(telemetry.mappingRule),
                subtitle: Text(
                  '${telemetry.mappingValidation} • ${telemetry.completionStatus}',
                ),
              ),
            ),
          ],
