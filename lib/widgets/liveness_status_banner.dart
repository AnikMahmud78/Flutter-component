...
class LivenessStatusBanner extends StatelessWidget {
  final double rate;

  const LivenessStatusBanner({super.key, required this.rate});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        'Liveness Criteria Execution Rate: \$rate% (Floor: 90.0%)',
