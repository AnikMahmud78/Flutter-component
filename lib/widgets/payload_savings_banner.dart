...
class PayloadSavingsBanner extends StatelessWidget {
  final double rate;

  const PayloadSavingsBanner({super.key, required this.rate});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        'Vector Migration Progress: \$rate% Completed (Floor: 90.0%)',
