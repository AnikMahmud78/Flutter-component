    ...
    body: ListView(
      ...
      children: [
        const ListTile(
          ...
          title: Text('6507BPWSO-027-12'),
          subtitle: Text(
            'Material trace health canvas with complete alert coverage.',
          ),
        ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Trace latency: 18ms (threshold: 200ms)',
        ...
        const Card.outlined(
          child: ListTile(
            title: Text('Observability / Alert Coverage: Good (100%)'),
            subtitle: Text('Google SRE monitoring standard'),
          ),
        ),
      ],
    ),
