...
class _TableSlicingWidgetState extends State<TableSlicingWidget> {
  final _dataset = List.generate(
    42,
    (index) => 'BigQuery Data Record Payload #${index + 1}',
  );
  int _pageIndex = 0;
          ...
          children: [
            Card.filled(
              ...
              child: const ListTile(
                ...
                subtitle: Text(
                  'Boundary-safe slicing returns an empty list for invalid pages.',
                ),
              ),
            ),
            const SizedBox(height: 16),
            Text(
              'Sliced Data Chunk (Page ${_pageIndex + 1} of $totalPages)',
