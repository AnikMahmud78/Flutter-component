// lib/widgets/pipe_filter_status_banner.dart
import 'package:flutter/material.dart';

class PipeFilterStatusBanner extends StatelessWidget {
  final String status;

  const PipeFilterStatusBanner({super.key, required this.status});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Ack Protocol Placement: Post-Write Enforced',
